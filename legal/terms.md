...
These are the terms for using **Miqra**, a Tanakh reader for Apple platforms operated by **KHASSINX LLC, a Florida limited liability company** ("KhassinX", "we").

By installing or using Miqra, you agree to these terms. If you do not agree, do not use the app.
...
Miqra grants you a personal, non-exclusive, non-transferable license to use the app on Apple devices that you own or control, in accordance with Apple's usage rules and these terms.

You may not reverse-engineer, decompile, or disassemble the app (except where applicable law expressly permits), remove or alter proprietary notices, use the app to develop a competing product, or use the app for any unlawful purpose.

## Pricing

Miqra is offered **pro bono — free of charge, with no advertising and no tracking.** An optional in-app tip jar lets you support the work voluntarily; it unlocks no content and is not required to use any feature. There is no subscription and no paywall on the text. Any tip is processed by Apple via the App Store; we never see your payment information.
...
To the maximum extent permitted by applicable law, KHASSINX LLC is not liable for indirect, incidental, special, consequential, or punitive damages arising from your use of the app. Nothing in these terms excludes or limits liability that cannot be excluded or limited by law.

## Termination

You may stop using Miqra at any time by deleting it from your devices. We may discontinue the app at any time.
...
If we change these terms, the new version replaces the old at this URL. The previous version remains accessible via the GitHub commit history of this site.
